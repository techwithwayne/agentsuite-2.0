(function () {
  ...
  const endpoint = "https://techwithwayne.pythonanywhere.com/agent/ask/";
  const popSound = new Audio("https://techwithwayne.pythonanywhere.com/static/agent/sounds/pop.mp3");
  popSound.volume = 0.2;

  const botAvatar = "https://techwithwayne.com/wp-content/uploads/2025/06/techwithwayne-featured-image-wayne-hatter.jpg";
  const greetingMessage = "Hey there! 👋 What’s good? Drop your website issue below and I’ll help get you squared away.";
...
`;
  ...
  function playPop() {
    try { popSound.currentTime = 0; popSound.play(); } catch (e) { console.warn(e); }
  }
  ...
  function loadScripts(urls, callback) {
    ...
    urls.forEach(url => {
      ...
      script.src = url;
      script.onload = () => { loaded++; if (loaded === urls.length) callback(); };
